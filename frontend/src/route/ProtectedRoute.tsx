...
import SupporterProfile from "@/components/Supporter/SupporterProfile"; // Ajustez le chemin
import ProviderProfile from "@/components/Provider/ProviderProfile"; // Ajustez le chemin
