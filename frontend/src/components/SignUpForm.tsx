...
export default function SignUpForm() {
  ...
  const countries = [
    ...
    "Austria", "Brazil", "Canada", "China", "Egypt", "France", "Germany", "India", 
    "Italy", "Japan", "Kenya", "Mexico", "Morocco", "Nigeria", "Qatar", "Russia", 
    "Saudi Arabia", "South Africa", "Spain", "United Kingdom", "United States", "UAE"
  ];
      ...
      <div className="flex-grow flex items-center justify-center relative py-8">
        ...
        <div className={`${themeClass} p-6 rounded-lg shadow-2xl shadow-gray-500/40 w-full max-w-2xl sm:max-w-3xl relative z-10`}>
          ...
          <div className="flex justify-center mb-8">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border ${
                    passwordMatch ? "border-slate-200" : "border-red-500"
            ...
            <button
              type="submit"
              className={`mt-6 w-full rounded-md bg-gradient-to-r from-green-700 to-red-700 py-3 px-4 border border-transparent text-center text-sm font-medium text-white transition-all shadow-md hover:shadow-lg focus:shadow-none active:shadow-none ${
          ...
          <div className="mt-4 text-center">
            <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              Already have an account?{' '}
              <Link href="/login" className="text-green-700 hover:text-green-600 font-semibold">
                Login
              </Link>
            </p>
          </div>
          ...
          <button
            ...
            className={`w-full flex items-center justify-center space-x-3 py-3 rounded-md mt-4 transition border ${
              isDarkMode ? "border-gray-700 text-white" : "border-gray-200 text-black"
            }`}
          >
            <FcGoogle size={24} />
