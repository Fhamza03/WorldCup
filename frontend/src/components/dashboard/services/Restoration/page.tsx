...
return (
    <div className={`min-h-screen ${themeClass} ` }>
        ...
        <div className="flex justify-between mt-6 ">
            {currentStep > 1 && <button onClick={handlePreviousStep} className="bg-gray-500 text-white px-4 py-2 rounded-lg">Back</button>}
            {currentStep < 3 && <button onClick={handleNextStep} className="bg-blue-500 text-white px-4 py-2 rounded-lg">Next</button>}
        </div>
        <Footer />
    </div>
)};
