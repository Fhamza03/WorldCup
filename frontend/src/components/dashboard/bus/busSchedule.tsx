...
export default function BusSchedule() {
  ...
  return (
    // Container without gradient background for the entire section
    <div className="w-full max-w-[96%] mx-6 p-3 bg-white rounded-lg shadow-sm h-5/12 items-center">
      {/* Parent Container to Wrap All Child Elements */}
      <div className="flex flex-col gap-2">
        ...
        <div className="flex justify-end gap-2">
          ...
          {/* Search button with the green-to-red gradient */}
          <button
