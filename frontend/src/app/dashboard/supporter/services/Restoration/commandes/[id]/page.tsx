...
// Dynamically import the SupporterOrders component to handle client-side rendering
const SupporterOrders = dynamic(() => import("@/components/dashboard/services/supporter/Restoration/order/liste/page"), {
